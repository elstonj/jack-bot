...
### IRAD Indirect R&D (Subcontractors & Internal): $100,179.52
**Total: $100,179.52** | **123 transactions** | **Largest: Boostr R&D Tax Credits $10,773.62; MicroFirm Engineering $6,257.60; Digi-Key Corp $1,438.87**

**New Transactions (July 27–30, 2026):**

| Purchase # | Date | Amount | Account | Description | Status |
|-----------|------|--------|---------|-------------|--------|
| Purchase #70183 | 2026-07-27 | $1,183.51 | IRAD-Internal Research and Development | JAWSTEC - 4617 | ✓ Confirmed |
...
**July 27–30 IRAD Additions**: $1,203.20 (2 transactions)

**Transaction Details**:

- **JAWSTEC Purchase (July 27, $1,183.51)**: Vendor item #4617
  - **Classification**: IRAD indirect R&D expense
  - **Probable Application**: Research equipment, test apparatus, or specialized tooling for autonomous VTOL development
  - **Context**: Aligns with post-Ottawa demo technical iteration and product refinement cycle
...
**Cumulative IRAD Activity (July 2024–30)**: $4,017.75 *(including prior 7/21, 7/23, 7/24 transactions plus new 7/27 and 7/30 activity)*
