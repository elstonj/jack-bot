# Nate Straus's Previously Assigned Tasks

## Overview

- **Owner:** Jack Elston (managing reassigned work following Nate Straus's removal from blackswifttech.com)
- **Status:** ACTIVE — 59 open tasks, 0 completed. The project is a backlog of unassigned work transferred when Nate left the organization.
- **Team:** Black Swift Technologies (whole team)
- **Timeline:** Tasks span from May 2026 through September 2026, with critical assembly and QC dates in August–September.
- **Risk Signals:** 
  - **Multiple tasks already past or approaching due dates** — Build 5 power switches (due 2026-05-21), Rebuild old BST S0 2024 (due 2026-06-19), and Finish 2025 S0's (due 2026-06-30) are all overdue.
...
### Build & Assembly (Core Aircraft Production)
- **Rebuild old BST S0 (2024 version)** — Due 2026-06-19 | Status: Open, Unassigned | *OVERDUE*
- **Finish 2025 S0's (full system packed)** — Due 2026-06-30 | Status: Open, Unassigned | *OVERDUE*
- **Install servos in tails** — No due date | Status: Open, Unassigned
- **Wire servos for tails** — No due date | Status: Open, Unassigned
- **Wire servos for wings** — No due date | Status: Open, Unassigned
- **Construct linkages** — No due date | Status: Open, Unassigned
- **Build 5 power switches with short PCB** — Due 2026-05-21 | Status: Open, Unassigned | *OVERDUE*
- **Assembly** — Due 2026-08-21 | Status: Open, Unassigned
- **QC Flight** — Due 2026-09-01 | Status: Open, Unassigned

### Maintenance
- **Trims (S10019)** — Aircraft maintenance task; associated with Ethan; status: Open, no due date

## Task Summary

### Overall Metrics
- **Total open:** 59
- **Total completed:** 0 (0% closure rate since task reassignment)
- **All tasks unassigned** — Major risk flag
...
- **Projects impacted:** 
  ...
  - [001-4] IRAD S0 VTOL — 8 orders
  - [451-1] INSTAAR S3 x2 — 8 orders
  - [001-16] IRAD Swiftstation — 8 orders
  - [212-2] NASA S2 & Parts — 2 orders
...
**2. Build & Assembly Tasks (9 tasks)**
- Status: Open, unassigned, mixed due dates
- Critical path items: 3 tasks overdue, 4 tasks with imminent deadlines (late August), 2 tasks without due dates
...
- **No consolidated budget tracking:** Individual order values not visible at project level; dollar total unknown.

## Recent Activity

### Completion Status
**No tasks have been completed since task reassignment.** Previous knowledge file noted 6 completed tasks (assembly latch carrier trays, 2x SHOW S0's, tripods, old S0 rebuild, CU IRISS repair); current data reflects 0 completed, indicating stagnation post-Nate Straus departure.

### Critical Path Exposure
- **Build tasks overdue:** 3 tasks past their June 2026 due dates (power switches, old S0 rebuild, 2025 S0 finish) remain open and unassigned.
...
1. **Project Orphaning:** All 59 tasks remain unassigned following Nate Straus's departure. Despite reassignment to Jack Elston as owner, no individual contributors have accepted ownership of specific work streams. No prioritization or sequencing is evident.

2. **Build Schedule Collapse:** 
   - 3 build tasks are overdue (May–June 2026 deadlines).
