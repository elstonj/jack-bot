...
- **Status:** **CRITICAL DELAY** — Original due date (Oct 2024) passed. As of late April 2026, **S0-VTOL has an active crash bug under investigation** (week of April 20, 2026); restart and flight tests in progress. **Bench test work overdue as of 2026-04-24** ("Visual Observation Bench Test"); "Instrumented Bench Test" due by Thursday following 2026-04-24 (Maciej Stachura, 2026-04-24 & 2026-04-30). S0 VTOL delivery blocker threatens May 22 handoff date. Operator training unassigned with no due date. Major deliverables remain open.
  - **Per Maciej Stachura (2026-04-30):** S0-VTOL is ranked #2 among top 5 BST company priorities: (1) S3 IRAD with end-of-May delivery target; (2) **S0-VTOL (two deliveries: ERAU and Barbados)**; (3) EMASS closeout; (4) By-Lite Mustang; (5) SBIR Magnetometer.
...
- **Risk Signals:** 
  ...
  - **Bench test work overdue as of 2026-04-24** ("Visual Observation Bench Test"); "Instrumented Bench Test" due by Thursday following 2026-04-24 (Maciej Stachura, 2026-04-30)
...
- **Beck Cotter:**
  ...
  - Bench test work overdue as of 2026-04-24; instrumented bench test due by Thursday following 2026-04-24 (Maciej Stachura, 2026-04-30)
...
- **Maciej Stachura:** 
  ...
  - **Priority confirmation (2026-04-30):** S0-VTOL ranked #2 among top 5 company priorities

- **Alex Lomis:** 
  - Project owner; secondary delivery task open with no due date; dependent on crash bug fix and bench tests

- **Unassigned:**
  - Conduct operator training (no due date) — **MUST ASSIGN AND SCHEDULE**

## Recent Activity
- **Week of April 20, 2026:** S0-VTOL crash bug discovered; active investigation and repair in progress; flight test restart scheduled. Maciej Stachura identified 4 main technical goals