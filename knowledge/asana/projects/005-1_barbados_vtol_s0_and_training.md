...
- **Status:** **CRITICAL DELAY — ACTIVE CRISIS (as of July 6, 2026)**
  - **S0 VTOL crash/tracking bug under active investigation and repair** (ongoing since mid-April 2026; flight test restart in progress per Beck Cotter, March 17, 2026)
  ...
  - **ISARRA campaign (two units) in QC phase; August delivery target confirmed with Kevin Adkins** (Slack, May 21, 2026; QC ongoing as of July 3, 2026)
- **Team Members:**
  - Alex Lomis (project owner)
  - Beck Cotter (S0 VTOL delivery lead)
  - Jack Elston (handoff/training lead; reassigned training documentation ownership per June 1 team correction)
