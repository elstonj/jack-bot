...
- **Status:** **CRITICAL DELAY — ACTIVE CRISIS (as of July 6, 2026)**
  ...
  - **ISARRA campaign (two units) in QC phase; August delivery target confirmed** (per team correction, July 6, 2026; QC ongoing; Kevin Adkins approved)
- **Team Members:**
...
- **Risk Signals:**
  ...
  - May 22 handoff due date critically at risk
...
| **Deliver S0 VTOL to Barbados** | Beck Cotter | 2026-05-22 | ⚠️ **CRITICAL BLOCKER** | Crash/tracking bug under active investigation; flight test restart in progress. Bench tests must complete first. **Per Maciej Stachura (May 4, 2026): "after your meeting with ByLight let's update the due dates in Asana to realistic numbers."** Current May 22 date likely unrealistic pending crash bug resolution. Platform: S0 VTOL; Order Qty: 1. Training/travel needed July 1–4. Also: **ISARRA campaign includes two additional S0 VTOL units with ground station and tablet for August/September 2026 delivery; both units in QC as of July 3, 2026per team correction, July 6, 2026.** |
...
| **ISARRA Campaign: Two S0 VTOL Units + Ground Station + Tablet** | Beck Cotter (build) / Kevin