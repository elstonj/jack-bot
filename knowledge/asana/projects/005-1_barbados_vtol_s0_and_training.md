...
| **Operator Training Materials & Supplies** | <@U04CZK4K7P0> (per Jack Elston, June 1, 2026, TEAM CORRECTION) | *No due date* | Open | Training curriculum and materials required for 6 trainees (including Junior Brathwaite). Sabu Best available week of May 5, 2025 (for preliminary materials review). **Must assign and finalize by June 2026.** **TEAM CORRECTION (Jack Elston, June 1, 2026):** Documentation and training ownership reassigned from <@U014ZL9FLE9> to <@U04CZK4K7P0> (not usually the owner of documentation, but should default here). |
