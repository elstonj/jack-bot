...
|---|---|---|
| **Beck Cotter** | 1 | Barbados S0 VTOL delivery (May 22, 2026). **CRITICAL:** Crash bug & flight restart blocking; bench tests overdue/in-progress. |