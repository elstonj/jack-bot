...
- **Timeline:**
  ...
  - **S0 VTOL delivery due: May 22, 2026 (CRITICAL DELAY — at imminent risk)**
...
- **Status:** **CRITICAL DELAY — ACTIVE CRISIS (as of July 6, 2026)**
  - **S0 VTOL crash/tracking bug under active investigation and repair** (flight test restart in progress per Beck Cotter, March 17, 2026)
  ...
  - May 22 delivery deadline at imminent risk; threatens June 23 handoff and July 1–4 training
  ...
  - **ISARRA campaign (two units) in QC phase; August delivery target confirmed** (per team correction, July 6, 2026; QC ongoing as of July 3, 2026; Kevin Adkins approved)
- **Team Members:**
  - Alex Lomis (project owner)
  - Beck Cotter (S0 VTOL delivery lead; flight-testing ongoing per March 17, 2026)
  - Jack Elston (handoff/training lead; reassigned training documentation ownership per June 1, 2026 team correction)
...
- **Risk Signals:**
  ...
  - May 22 handoff due date critically at risk if crash bug repair extends beyond next 1–2 weeks
  - Ground station asset scarcity (Jack Elston, April 20, 2026): potential hardware reprioritization if timeline slips further
  - **Operator training unassigned and without formal due date** despite imminent July 1–4 travel and 6-person commitment
  - NDAA compliance not finalized (Alex Lomis, April 17, 2026: "can be" compliant but not "fully" compliant)
...
| **Operator Training Materials & Supplies** | Jack Elston (reassigned per June 1, 2026 team correction) | *No due date set* | ⚠️ **AT RISK** | Training curriculum and materials for 6 trainees (including Junior Brathwaite). Sabu Best available week of May 5, 2025 for preliminary review. **TEAM CORRECTION (Jack Elston, June 1, 2026):** Documentation and training ownership reassigned from prior assignee to Jack Elston (better suited as default owner). Must finalize by June 2026. |
| **Operator Training Delivery** | Jack Elston | 2026-07-01–04 | ⚠️ **At Risk** | In-person training in Barbados; 6 trainees. Mission: operate S0 VTOL east of Barbados to intercept developing storms; launch site tentatively Bushy Park. Dependent on S0 VTOL delivery and June 23 handoff. Travel scheduled. |
...
| **NDAA Compliance Finalization** | *Not assigned* | *Not scheduled* | ⚠️ **OPEN** | Per Alex Lomis (April 17, 2026): S0 VTOL "can be" compliant but not "fully" compliant yet.