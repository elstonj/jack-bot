...
- **Timeline:**
  ...
  - **S0 VTOL delivery due: May 22, 2026 (CRITICAL DELAY — substantially overdue)**
...
- **Status:** **CRITICAL DELAY — ACTIVE CRISIS (as of July 6, 2026)**
  ...
  - **ISARRA campaign (two units) in QC phase; August delivery target confirmed** (per team correction, Jack Bot, July 6, 2026; QC ongoing; Kevin Adkins approved)
- **Team Members:**
...
| **NDAA Compliance Finalization** | *Not assigned* | *Not scheduled* | ⚠️ **OPEN** | Per Alex Lomis (April 17, 2026): S0 VTOL "can be" compliant but not