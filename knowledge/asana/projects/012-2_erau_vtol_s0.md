...
- **Status:** **ACTIVE, SECOND-HIGHEST PRIORITY (after S3 IRAD), SEVERELY DELAYED — CRITICAL TECHNICAL BLOCKERS.** Per Maciej (April 24 & 30, 2026), S0-VTOL is second-highest priority project with **two deliveries owed: ERAU and Barbados** (Barbados delivery previously undocumented — requires urgent contract clarification). S0-VTOL unit remains in active development/troubleshooting as of April 24, 2026. Unit experienced crash; engineering team actively working on root cause analysis and fix. **Overdue bench test tasks require immediate completion:** Visual Observation Bench Test is **overdue**; Instrumented Bench Test was **due by April 25, 2026** per Maciej (April 24, 2026). No confirmed delivery date set. Project delivery contingent on crash bug resolution, bench testing completion, and NDAA compliance pathway completion.
- **Team Members:** Alex Lomis (owner/lead, engineering), Jack Elston (delivery coordination), Dan Prendergast (training), Maciej (project coordination/status tracking), U058LGYMEQ0 (bench testing/S0-VTOL troubleshooting lead), U014ZL9FLE9 (crash bug investigation), plus broader engineering team
- **Risk Signals:** 
  ...
  - **No Clear Delivery Date:** Jack Elston assigned "Final due date for delivery" task but has not established a date; blocking all downstream logistics
  - **Supply Chain Contingency:** Per Jack Elston (April 20, 2026), potential to "shift some older ground stations from the S0-VTOL kits depending on timeline" — indicates internal resource constraints; willing to adapt delivery logistics to meet project needs
...
- **Context:** Unit experienced crash during testing; root cause investigation and fix underway as of April 20, 2026 (Maciej) — one of 4 primary technical milestones for week of April 20, 2026
...
### Barbados Delivery (Second Delivery Obligation — URGENT CLARIFICATION NEEDED)
- **Status:** Per Maciej (April 24 & 30, 2026), S0-VTOL has "two deliveries for ERAU and Barbados" as second-highest priority project (after S3 IRAD)
- **Context:** **NEW INFORMATION — not previously documented in project records.** Requires urgent clarification: Is this a separate contract? Separate unit? Same S0-VTOL unit? Contract terms? Dollar value? Timeline?
- **Risk:** May compete for S0-VTOL unit or engineering resources with ERAU delivery; timeline and contract status unknown — could impact both deliveries if resources or unit conflict
