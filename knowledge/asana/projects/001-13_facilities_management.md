...
- **Status**: Active - recurring operational cadence maintained. **Current snapshot: 1 open task** (Office Cleaning due 2026-07-14). Weekly purchasing coordination and bi-weekly cleaning continue to cycle through the system.
...
## Task Summary
- **Total tasks**: 1 open, 0 completed (in current export)
- **Tasks by assignee**:
...
**Key Vendors:**
- **Landlord**: Goose Creek
  - Property Manager: Amy Smith
  - Email: amy@wwreynolds.com
  - Phone: 303-941-8243 (cell) / 303-442-8687 (office)

- **Cleaning Service**: Neat N Tidy
  - Booking portal: https://neatntidy.bookingkoala.com/
  - Login: purchasing@blackswifttech.com / 297EZXULBMbZyY
...
| Period | Rate (NNN) | CAM |
|--------|-----------|-----|
| Months 1–12 | $13.00 | $6.23 |
| Months 13–24 | $13.39 | $6.23 |
| Months 25–36 | $13.79 | $6.23 |
