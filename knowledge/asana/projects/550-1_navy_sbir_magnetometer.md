...
- **Client/Customer:** Department of the Navy (NAVAIR, NAWCAD)
  ...
  - Phone: (240) 587-9542 (Ruiz-Reyes); (240) 538-5265 (Brescia)
...
- **Timeline:**
  - Phase I completed: January 2026
  - **Option Period:** April 14, 2026 – September 28, 2026
  - **Key Dates:**
...
- **Status:** Active – Option Period underway (kicked off April 21, 2026). Per Maciej Stachura (Apr 22, 2026): "the Navy SBIR Magnetometer project has kicked off as of today. Make sure to track those tasks as part of the daily updates." **Technical lead: Jack Elston** with support from Alex Lomis, Maciej Stachura, Beck Cotter, Meredith O'hara Needham, and Dan Prendergast.
- **Team Members:** 
  - Alex Lomis (PM/owner)
  ...
  - Dan Prendergast
- **Risk Signals:** 
  - **Heavy task load on Alex Lomis:** 8 of 19 open tasks assigned to him, spanning design, procurement, build, and flight testing through Aug 17.
  - **Compressed technical timeline:** Design phase (Apr 27–May 5) feeds directly into build (May 19) and ground testing (May 29), with hand-launched flights due July 1 and Camp Pendleton demo due Aug 17—all before CLIN 0007 final report deadline (Sep 28).
...
**Option Period Administrative Deliverables (April–September 2026):**
| CLIN | Deliverable | Amount | Due Date | Status |
|------|---|---|---|---|
| 0005 | Kick-Off & FWA Certification Report + Invoice | $50,000 | Apr 14, 2026 | ✓ Completed |
...
## Task Summary
- **Total Tasks (Current):** 19 open, 0 completed
  - 6 administrative deliverables (reports + invoices)
  - 13 technical work tasks
- **Full Project History:** 46+ total tasks across Phase I and Option Period (27 Phase I tasks completed; 19 Option Period tasks ongoing)
- **Tasks by Assignee (Current):**
  - **Alex Lomis:** 8 open tasks (42% of workload)
  ...
  - **Jack Elston:** 3 open tasks
    ...
    - CLIN 0006 Progress Report (Due Jun 29)
    - CLIN 0007 Final Report (Due Sep 28)
  ...
  - **Maciej Stachura:** 2 open tasks
    ...
    - *Note: Per Maciej (Apr 20, 2026): "Mexico is moved to the Fall, so no flight planning happening soon. Tasks for the Navy project is done" — this refers to a separate project (Mexico/Fall), not the Navy SBIR. Navy tasks remain active.*
  - **Beck Cotter:** 1 open task
    - Camp Pendleton permissions/frequencies finalization (Due Jun 1)
  - **Meredith O'hara Needham:** 2 open tasks
    - CLIN 0006 Invoice ($35,000, Due Jun 29)
    - CLIN 0007 Invoice ($14,459, Due Sep 28)
  - **Unassigned:** 2 contact/reference tasks
    - Angel Ruiz-Reyes (TPOC contact info)
    - Anthony