...
- **NextTech Solutions - S3 Arctic** (Beck Cotter) – Was due 2026-05-29; last contact 2026-03-17. Customer: NextTech Solutions / Joint Forces Command; seeking 120km range EO/IR gimbal system.
- **National Oceanography Centre - Greenland Project** (Maciej Stachura) – Was due 2026-05-29; last contact 2026-03-17. ARIA-funded UK research; 2027 shakedown campaign planned.
- **Canadian Rangers Demo (Ottawa)** (NexTech / Canadian Defense Forces) – Was due 2026-06-25.
- **S0 VTOL Oklahoma State** (Jamey D. Jacob, PhD; Oklahoma State University) – Was due 2026-04-24.
...
- **UC Santa Cruz S3** (Kevin Rozmiarek referral) – Prior knowledge noted this was completed 2026-05-15; no longer in current view.
- **Barbados S2**.

## Task Summary
- **Total tasks**: 1 open, 0 completed (in current Asana view)
  - **Critical discrepancy**: Prior refresh tracked 2 open tasks + 1 recently completed (UC Boulder). Current view shows only 1 open task (Acellant S2). **Status of 9+ previously tracked opportunities unknown.**

- **Open Tasks by Assignee**:
  - **Jack Elston** (1 open):
    - Acellant S2 (DUE 2026-05-22; last contact 2026-01-14, 4+ months stale)

- **Notable patterns**:
  - Project structure change: "Expanded leads to its own Sales Portfolio" with new forms and rules (Jun 26 status update). Opportunities likely migrated to separate portfolio or archived.
  - Heavy use of custom fields for deal tracking (customer, contact, products, opportunity source, first/last contact dates).
  - Diverse aircraft platforms in demand (S0, S2, S3, E2).
  - Strong emphasis on government/defense (USAF, Royal Navy, DoD, Canadian Defense Forces) and academic/research sectors.
  - Custom payload and sensor focus (EO/IR gimbal, multispectral, LiDAR, thermal, magnetometer).
  - International expansion (Canada, UK, Greenland).
  - **Data integrity**: Current custom field values show $0 across all visible tasks.

## Recent Activity
- **Jun 26**: Status update notes expansion to Sales Portfolio structure with new forms and rules targeting $5M by end of 2025; BD person hire planned for end of July 2025.
- **2026-01-14**: Last contact on Acellant S2 (4+ months ago); no visible follow-up activity.
- **Prior data**: Two opportunities (NextTech Arctic, NOC Greenland) were last active 2026-03-17 (2+ months in previous refresh); now missing from current view.

## Notes & Context
1. **Pipeline visibility crisis**: 9+ previously tracked opportunities missing from current task list. Confirm whether these were:
   - Migrated to new Sales Portfolio structure (if so, locate and audit new portfolio immediately)
   - Archived/closed without documentation
   - Completed without task closure
   - Lost during restructure
