...
- **Timeline:** Open task order PO through 2025-12-31 **(extended due 2026-05-05 India demo cancellation)**
...
## Key Context
This is a **standing task order agreement**, not a fixed-scope project. ByLight submits individual task orders on an on-demand basis; BST budgets, approves, completes, and invoices each task. The short DoD deadline drives rapid design and prototyping cycles.
