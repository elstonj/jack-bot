...
## Overview
This channel is focused on Black Swift Technologies' Navy Small Business Innovation Research (SBIR) project for developing magnetometer-equipped aircraft systems. The project involves integrating QuSpin and Bartington magnetometers with BST's aircraft platforms for magnetic signature detection applications (MAD - Magnetic Anomaly Detection). Key participants include Beck Cotter, Maciej, Tyler, Sam Hild, Alex Lomis, Joshua Fromm, Jack Elston, and Ethan Domagala from BST, with external collaboration from QuSpin (Jeff), Ultra Maritime (Paul), Navy DEVCOM (Morris "DeSi"), Navy TPOC (Angel Ruiz-Reyes), Royal Navy contact Simon, Lockheed Martin UK (LMUK), external consultant Eric Correa, and other Navy personnel (Daniel Klier, Aaron Pyrah, Derek). Activity spans from October 2025 through September 2026, covering Phase I completion, Phase II proposal submission and kickoff, Option period development with flight testing preparation, sensor optimization work, TCE (Technology Concept Experimentation) event participation at Camp Pendleton (rescheduled from August 17-28 to September 14-24), and on-site testing and TAK integration with Navy personnel.
...
- Royal Navy Q2 2027 helicopter drop specs: Open to all S0 options (S0-weather, S0-MAD, or S0 with onboard camera); would be dropped over ocean near airbase, ground-controlled initially (similar to C-130 setup), and recovered at airfield. Onboard video recording requested as marketing tool for project expansion (July 