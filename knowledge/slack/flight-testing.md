...
- **May 14, 2026:** S1-VTOL failure testing comprehensive test plan approved for May 15 flight operations; includes mag failure landing (gyro integration), loss of laser on landing, low battery flight terminate with transition, joystick transition, lost GPS, and loss of engine in flight. Loss of pitot and loss of pitot + GPS deferred due