...
**Key Participants:** Maciej (lead flight testing/analysis), Jack Elston (firmware development), Joshua Fromm (QA/component sourcing), Ben Busby (tablet/GCS software), Nate (videography/pilot), Alex Lomis (field operations/media/pilot), Sam Hild (Remote ID integration/test pilot/magnetometer troubleshooting), Dan Prendergast (autopilot/control systems/operations), Danny Troke (data management), Ethan Domagala (pilot/tablet operator), Beck Cotter (operations support), Paige Smith (media/video curation), Meredith Needham (logistics/administrative support), Scott (equipment/field operations), Stefan (payload data processing - CH4/CO2), Spencer Hoehl (QA/maintenance workflow coordination), Sunny Slope Sod Farm (external airspace contact/CU training partner), Chris & Kevin (external clients/stakeholders), Christoph & Angie (internal stakeholders), Dan H. (external contact/AUVSI show), Ken Jochim (BAS airfield operator), Boulder Emergency Squad (external visitor/stakeholder), NRL/Naval Research Laboratory (external client/payload testing), Matt at NRL (external contact/gimbal payload lead), Brian (external stakeholder/SOCOM demo operator)

**Activity Level:** Extremely high — 5,600+ messages across June 2020 through August 2026. Daily operations with multiple aircraft flights, rapid issue turnaround, continuous firmware iterations, and intensive VTOL transition testing. Current activity (August 2026) shows intensive S1-VTOL and S0-VTOL development with focus on ESC stability, communications reliability, Remote ID integration, hard landing mitigation, and endurance testing. Latest activity (August 25-26, 2026) indicates S0-VTOL rapid iteration testing at Sod Farm with target of 25-30+ quick transition flights per battery, battery optimization trials (55% min takeoff / 40% min landing), and field charging protocols.
...
- **May 14, 2026:** S1-VTOL failure testing comprehensive test plan approved for May 15 flight operations; includes mag failure landing (gyro integration), loss of laser on landing