...
**Key Participants:** Maciej (lead flight testing/analysis), Jack Elston (firmware development), Joshua Fromm (QA/component sourcing), Ben Busky (tablet/GCS software), Nate (videography/pilot), Alex Lomis (field operations/media/pilot), Sam Hild (Remote ID integration/test pilot/magnetometer troubleshooting), Dan Prendergast (autopilot/control systems/operations), Danny Troke (data management), Ethan Domagala (pilot/tablet operator), Beck Cotter (operations support), Paige Smith (media/video curation), Meredith Needham (logistics/administrative support), Scott (equipment/field operations), Stefan (payload data processing - CH4/CO2), Spencer Hoehl (QA/maintenance workflow coordination/process formalization lead), Sunny Slope Sod Farm (external airspace contact/CU training partner), Chris & Kevin (external clients/stakeholders), Christoph & Angie (internal stakeholders), Dan H. (external contact/AUVSI show), Ken Jochim (BAS airfield operator), Boulder Emergency Squad (external visitor/stakeholder), NRL/Naval Research Laboratory (external client/payload testing), Matt at NRL (external contact/gimbal payload lead/battery support), Brian (external stakeholder/SOCOM demo operator), ERAU (external partner - isarra project), NREL (external contact - equipment/batteries)

**Activity Level:** Extremely high — 5,600+ messages across June 2020 through September 2026. Daily operations with multiple aircraft flights, rapid issue turnaround, continuous firmware iterations, and intensive VTOL transition testing. Activity through September 18, 2026 shows S20009 QC flight validation, ByLight external client test flight operations at Sunny Slope Sod Farm, and continued coordination between firmware development and flight testing logistics. Aircraft readiness management, payload integration (launcher systems with custom tanks/valves), and external partner flight operations remain active focus areas.
...
- **September 15, 2026:** S20009 QC flight completed and passed; aircraft approved for operations with firmware validation (SW v3028, HW v2050, code revision 4fb65e96 from master branch)
- **September 17, 2026:** ByLight external client test flight planned for September 18, 2026 at Sunny Slope Sod Farm; departure scheduled shortly after 9:00 AM from office with preflight target of 10:00 AM at sod farm; Dan Prend